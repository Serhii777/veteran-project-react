...
import { createItem } from "../../services/useFetchArray";
...
const FormContent = () => {
  ...
  return (
    <div className={styles.formAdminWrapper}>
      <h2 className={styles.formAdminTitle}>Форма наповнення сторінки</h2>
            ...
            <form onSubmit={handleSubmit} className={styles.formContent}>
              ...
              <div className={styles.formButtonWrapper}>
                <div className={styles.formButtonAdd}>
                  <button
                    type="button"
                    onClick={() => push("hometext", undefined)}
                ...
                <div className={styles.formButtonDelete}>
                  <button
                    type="button"
                    onClick={() => pop("hometext")}
                    className={styles.formButton}>
                    Очистити поточний блок тексту
                  </button>
                </div>
              </div>
              <FieldArray name="hometext" className={styles.blockContent}>
                {({ fields }) =>
